...
JULIET_BINARIES_DIR="/mnt/z/juliet/C/dataset/train/CWE190_Integer_Overflow/stripped"
...
find "${JULIET_BINARIES_DIR}" -type f -name "*.out" | while read -r STRIPPED_BIN; do
    ...
    UNSTRIPPED_BIN="/mnt/z/juliet/C/dataset/train/CWE190_Integer_Overflow/dbg/${BASE_NAME}.unstripped"
